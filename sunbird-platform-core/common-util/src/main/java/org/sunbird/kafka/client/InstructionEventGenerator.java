...
public class InstructionEventGenerator {
    ...
    private static String generateInstructionEventMetadata(Map<String, Object> data) {
       ...
       if(MapUtils.isNotEmpty((Map)data.get("object")))
           object.putAll((Map)data.get("object"));
    ...
    private static String logInstructionEvent(Map<String,Object> actor, Map<String,Object> context, Map<String,Object> object, Map<String,Object> edata) {
