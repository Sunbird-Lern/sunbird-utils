...
public enum ResponseCode {
  ...
  certIdRequired(ResponseMessage.Key.CERT_ID_MISSING, ResponseMessage.Message.CERT_ID_MISSING),
  accessCodeRequired(ResponseMessage.Key.ACCESS_CODE_MISSING, ResponseMessage.Message.ACCESS_CODE_MISSING),
  accessCodeInvalid(ResponseMessage.Key.INVALID_ACCESS_CODE, ResponseMessage.Message.INVALID_ACCESS_CODE),
  OK(200),
  CLIENT_ERROR(400),
  SERVER_ERROR(500),
