...
public class CqlMigrationResolverTest {
  ...
  public void extractScriptName() {
    ...
    assertEquals(
        "db_0__init.cql",
        cqlMigrationResolver.extractScriptName(
            new ClassPathResource(
                "db/migration/db_0__init.cql", Thread.currentThread().getContextClassLoader())));
  }
  ...
  public void extractScriptNameRootLocation() {
    ...
    assertEquals(
        ...
        cqlMigrationResolver.extractScriptName(
            new ClassPathResource(
                "db_0__init.cql", Thread.currentThread().getContextClassLoader())));
  }
