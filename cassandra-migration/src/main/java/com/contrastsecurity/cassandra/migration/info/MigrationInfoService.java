...
public class MigrationInfoService {
  ...
  /**
   * Merges the available and the applied migrations to produce one fully aggregated and
   * consolidated list.
   *
   ...
   */
  /* private -> testing */
  private List<MigrationInfo> mergeAvailableAndAppliedMigrations(
      Collection<ResolvedMigration> resolvedMigrations, List<AppliedMigration> appliedMigrations) {
