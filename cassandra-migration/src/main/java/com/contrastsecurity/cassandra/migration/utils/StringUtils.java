...
public class StringUtils {
   ...
   * returns false.
   *
   * <p>{@code null} will return {@code false}. An empty String ("") will return {@code true}.
   *
   * <pre>
  ...
  /**
   * Returns the first n characters from this string, where n = count. If the string is shorter, the
   * entire string will be returned. If the string is longer, it will be truncated.
   *
  ...
  /**
   * Convenience method to return a Collection as a comma-delimited String. E.g. useful for {@code
  ...
  /**
   * Convenience method to return a Collection as a delimited String. E.g. useful for {@code
   * toString()} implementations.
   *
   * @param collection the Collection to analyse
