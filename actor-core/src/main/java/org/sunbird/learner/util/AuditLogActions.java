...
public class AuditLogActions {
	...
	static {
		...
		auditLogUrlMap.put(ActorOperations.CREATE_ORG.getValue(),
				new AuditOperation(JsonKey.ORGANISATION, JsonKey.CREATE));
		auditLogUrlMap.put(ActorOperations.UPDATE_ORG.getValue(),
				new AuditOperation(JsonKey.ORGANISATION, JsonKey.UPDATE));
		auditLogUrlMap.put(ActorOperations.UPDATE_ORG_STATUS.getValue(),
				new AuditOperation(JsonKey.ORGANISATION, JsonKey.UPDATE));
		auditLogUrlMap.put(ActorOperations.APPROVE_ORG.getValue(),
				new AuditOperation(JsonKey.ORGANISATION, JsonKey.UPDATE));
		auditLogUrlMap.put(ActorOperations.APPROVE_ORGANISATION.getValue(),
				new AuditOperation(JsonKey.ORGANISATION, JsonKey.UPDATE));
		auditLogUrlMap.put(ActorOperations.JOIN_USER_ORGANISATION.getValue(),
				new AuditOperation(JsonKey.ORGANISATION, JsonKey.UPDATE));
		auditLogUrlMap.put(ActorOperations.ADD_MEMBER_ORGANISATION.getValue(),
				new AuditOperation(JsonKey.ORGANISATION, JsonKey.UPDATE));
		auditLogUrlMap.put(ActorOperations.REMOVE_MEMBER_ORGANISATION.getValue(),
				new AuditOperation(JsonKey.ORGANISATION, JsonKey.UPDATE));
		auditLogUrlMap.put(ActorOperations.APPROVE_USER_ORGANISATION.getValue(),
				new AuditOperation(JsonKey.ORGANISATION, JsonKey.UPDATE));
		auditLogUrlMap.put(ActorOperations.REJECT_USER_ORGANISATION.getValue(),
				new AuditOperation(JsonKey.ORGANISATION, JsonKey.UPDATE));
		...
		auditLogUrlMap.put(ActorOperations.ADD_USER_TO_BATCH.getValue(),
				new AuditOperation(JsonKey.BATCH, JsonKey.UPDATE));
		auditLogUrlMap.put(ActorOperations.REMOVE_USER_FROM_BATCH.getValue(),
				new AuditOperation(JsonKey.BATCH, JsonKey.UPDATE));
