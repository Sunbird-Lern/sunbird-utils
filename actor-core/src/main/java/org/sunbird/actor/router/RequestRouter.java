				...
				if (failure != null) {
					...
					if (failure instanceof ProjectCommonException) {
						...
						ProjectCommonException exception = new ProjectCommonException(
								ResponseCode.operationTimeout.getErrorCode(), ResponseCode.operationTimeout.getErrorMessage(),
					...
					if (result instanceof Response
						...
						AuditOperation auditOperation = (AuditOperation) AuditLogActions.auditLogUrlMap
