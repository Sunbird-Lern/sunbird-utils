	...
	public static void main(String[] args) {
		...
		if(bool){
	    	...
	    	contentmap.put("contentid", "cont-2445123");
	   		...
	   		contentmap.put("lastaccesstime", "2017-05-15 10:58:07:509+0530");//new Timestamp(new Date().getTime())
	   		contentmap.put("lastcompletedtime", "2017-05-15 10:58:07:509+0530");
	   		contentmap.put("viewposition", "pos1");
	   		contentmap.put("datetime", new Timestamp(System.currentTimeMillis()));
