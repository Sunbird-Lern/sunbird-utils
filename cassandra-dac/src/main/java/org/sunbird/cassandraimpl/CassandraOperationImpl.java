...
public class CassandraOperationImpl implements CassandraOperation {
	...
	public Response insertRecord(String keyspaceName, String tableName, Map<String, Object> request) {
		...
		try {
			...
			if (e.getMessage().contains(JsonKey.UNKNOWN_IDENTIFIER)
				...
				ProjectLogger.log("Exception occured while inserting record to " + tableName + " : " + e.getMessage(),
						e);
			...
			throw new ProjectCommonException(ResponseCode.dbInsertionError.getErrorCode(),
					ResponseCode.dbInsertionError.getErrorMessage(), ResponseCode.SERVER_ERROR.getResponseCode());
		}
		long stopTime = System.currentTimeMillis();
		long elapsedTime = stopTime - startTime;
		ProjectLogger.log(
				"Cassandra Service insertRecord method end at ==" + stopTime + " ,Total time elapsed = " + elapsedTime,
				LoggerEnum.PERF_LOG);
		return response;
	}
	...
	public Response updateRecord(String keyspaceName, String tableName, Map<String, Object> request) {
		...
		try {
			...
			throw new ProjectCommonException(ResponseCode.dbUpdateError.getErrorCode(),
					ResponseCode.dbUpdateError.getErrorMessage(), ResponseCode.SERVER_ERROR.getResponseCode());
		}
		long stopTime = System.currentTimeMillis();
		long elapsedTime = stopTime - startTime;
		ProjectLogger.log(
				"Cassandra Service updateRecord method end at ==" + stopTime + " ,Total time elapsed = " + elapsedTime,
				LoggerEnum.PERF_LOG);
		return response;
	}
	...
	public Response deleteRecord(String keyspaceName, String tableName, String identifier) {
		...
		long elapsedTime = stopTime - startTime;
		ProjectLogger.log(
				"Cassandra Service deleteRecord method end at ==" + stopTime + " ,Total time elapsed = " + elapsedTime,
				LoggerEnum.PERF_LOG);
		return response;
	}
	...
	public Response getRecordById(String keyspaceName, String tableName, String identifier) {
		...
		long elapsedTime = stopTime - startTime;
		ProjectLogger.log(
				"Cassandra Service getRecordById method end at ==" + stopTime + " ,Total time elapsed = " + elapsedTime,
				LoggerEnum.PERF_LOG);
		return response;
	}
	...
	public Response getAllRecords(String keyspaceName, String tableName) {
		...
		long elapsedTime = stopTime - startTime;
		ProjectLogger.log(
				"Cassandra Service getAllRecords method end at ==" + stopTime + " ,Total time elapsed = " + elapsedTime,
				LoggerEnum.PERF_LOG);
		return response;
	}
	...
	public Response upsertRecord(String keyspaceName, String tableName, Map<String, Object> request) {
		...
		long elapsedTime = stopTime - startTime;
		ProjectLogger.log(
				"Cassandra Service upsertRecord method end at ==" + stopTime + " ,Total time elapsed = " + elapsedTime,
				LoggerEnum.PERF_LOG);
		return response;
