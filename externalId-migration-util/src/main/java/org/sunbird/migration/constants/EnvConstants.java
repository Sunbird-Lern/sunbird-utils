...
public class EnvConstants {
  ...
  public static final String PRE_PROCESSED_RECORDS_FILE_SELF_DECLARED = "preProcessedRecords_selfdeclared.txt";
  public static final String PRE_PROCESSED_RECORDS_FILE_STATE_USERS = "preProcessedRecords_stateusers.txt";
