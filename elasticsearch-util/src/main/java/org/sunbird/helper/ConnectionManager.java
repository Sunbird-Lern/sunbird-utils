...
public class ConnectionManager {
	...
	/**
	 * This method will read configuration data form properties file and update the
	 * list.
	 * 
	 * @return boolean
	 */
	 ...
	 * @return boolean
	 */
	public static boolean initialiseConnectionFromPropertiesFile(String cluster, String hostName, String port) {
		try {
