...
public class ElasticSearchUtilTest {
  ...
  public void createDataTest() {
    String responseId =
        ElasticSearchUtil.createData(indexName, typeName, (String) map.get("courseId"), map);
  ...
  public void getByIdentifier() {
    Map<String, Object> responseMap =
        ElasticSearchUtil.getDataByIdentifier(indexName, typeName, (String) map.get("courseId"));
  ...
  public void updateByIdentifier() {
    ...
    boolean response =
        ElasticSearchUtil.updateData(indexName, typeName, (String) map.get("courseId"), innermap);
    assertTrue(response);
  }
  ...
  public void getByIdentifierWithOutIndex() {
    Map<String, Object> responseMap =
        ElasticSearchUtil.getDataByIdentifier(null, typeName, (String) map.get("courseId"));
  ...
  public void getByIdentifierWithOutType() {
    Map<String, Object> responseMap =
        ElasticSearchUtil.getDataByIdentifier(indexName, null, "testcourse123");
    assertEquals(0, responseMap.size());
  }
  ...
  public void getDataWithOutIdentifier() {
    Map<String, Object> responseMap =
        ElasticSearchUtil.getDataByIdentifier(indexName, typeName, "");
    assertEquals(0, responseMap.size());
  }
  ...
  public void updateWithNullMap() {
    boolean response =
        ElasticSearchUtil.updateData(indexName, typeName, (String) map.get("courseId"), null);
    assertFalse(response);
  }
  ...
  public void upsertDataWithOutIndex() {
    ...
    innermap.put("organisationId", "updatedOrgId");
    boolean response =
        ElasticSearchUtil.upsertData(null, typeName, (String) map.get("courseId"), innermap);
    assertFalse(response);
  }
  ...
  public void upsertDataWithOutIndexType() {
    ...
    innermap.put("organisationId", "updatedOrgId");
    boolean response =
        ElasticSearchUtil.upsertData(null, null, (String) map.get("courseId"), innermap);
    assertFalse(response);
  }
  ...
  public void upsertDataWithEmptyMap() {
    Map<String, Object> innermap = new HashMap<>();
    boolean response =
        ElasticSearchUtil.upsertData(indexName, typeName, (String) map.get("courseId"), innermap);
    assertFalse(response);
  }
  ...
  public void createIndexWithEmptyMapping() {
    boolean response =
        ElasticSearchUtil.createIndex(
            indexName, typeName, null, ElasticSearchSettings.createSettingsForIndex());
    assertFalse(response);
  }
  ...
  public void createIndexWithEmptySettings() {
    boolean response =
        ElasticSearchUtil.createIndex(
            indexName, typeName, ElasticSearchMapping.createMapping(), null);
    assertFalse(response);
  }
  ...
  public void saveDataWithOutIndexname() {
    String responseMap =
        ElasticSearchUtil.createData("", typeName, (String) map.get("courseId"), map);
  ...
  public void saveDataWithOutTypeName() {
    String responseMap =
        ElasticSearchUtil.createData(indexName, "", (String) map.get("courseId"), map);
    assertEquals("ERROR", responseMap);
  }
  ...
  public void mappingAddOrUpdateTest() {
    boolean bool =
        ElasticSearchUtil.addOrUpdateMapping(
            indexName, typeName, ElasticSearchMapping.createMapping());
    assertTrue(bool);
  }
