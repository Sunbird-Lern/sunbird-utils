...
public class MigrationVersionTest {
  ...
  public void fromVersionFactory() {
    assertEquals(
        ...
        MigrationVersion.fromVersion(MigrationVersion.LATEST.getVersion()));
    assertEquals(
        MigrationVersion.EMPTY, MigrationVersion.fromVersion(MigrationVersion.EMPTY.getVersion()));
  ...
  public void testWouldOverflowLong() {
    final String raw =
        "9999999999999999999999999999999999.8888888231231231231231298797298789132.22";
