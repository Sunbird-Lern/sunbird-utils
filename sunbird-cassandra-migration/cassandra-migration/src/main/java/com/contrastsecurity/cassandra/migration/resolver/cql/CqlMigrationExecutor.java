...
public class CqlMigrationExecutor implements MigrationExecutor {
  ...
  /**
   * The Resource pointing to the cql script. The complete cql script is not held as a member field
   * here because this would use the total size of all cql migrations files in heap space during db
   * migration.
   */
