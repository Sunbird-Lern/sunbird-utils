...
public class AppliedMigration implements Comparable<AppliedMigration> {
   ...
   * @param installedRank The order in which this migration was applied amongst all others. (For out
   *     of order detection)
   * @param version The target version of this migration.
   * @param description The description of the migration.
   * @param type The type of migration (INIT, CQL, ...)
   * @param script The name of the script to execute for this migration, relative to its classpath
   *     location.
  ...
  /**
   * @return The order in which this migration was applied amongst all others. (For out of order
   *     detection)
   */
  ...
  /**
   * @return The name of the script to execute for this migration, relative to its classpath
   *     location.
   */
