...
public enum MigrationState {
  ...
  /**
   * This migration has not been applied yet, and won't be applied because target is set to a lower
   * version.
   */
  ABOVE_TARGET(">Target", true, false, false),

  /**
   * This migration was not applied against this DB, because the metadata table was baselined with a
   * higher version.
   *
   ...
   *
   * <p>This migration was not applied against this DB, because a migration with a higher version
   * has already been applied. This probably means some checkins happened out of order.
   *
   * <p>Fix by increasing the version number, run clean and migrate again or rerun migration with
   * outOfOrder enabled.
   */
   ...
   *
   * <p>This migration was applied against this DB, but it is not available locally. This usually
   * results from multiple older migration files being consolidated into a single one.
   */
   ...
   * results from multiple older migration files being consolidated into a single one.
   *
   * <p>This should rarely, if ever, occur in practice.
   */
   ...
   * This migration succeeded.
   *
   * <p>This migration succeeded, but it was applied out of order. Rerunning the entire migration
   * history might produce different results!
   */
   ...
   * This migration succeeded.
   *
   * <p>This migration has been applied against the DB, but it is not available locally. Its version
   * is higher than the highest version available locally. It was most likely successfully installed
   * by a future version of this deployable.
   */
   ...
   *
   * <p>This migration has been applied against the DB, but it is not available locally. Its version
   * is higher than the highest version available locally. It most likely failed during the
   * installation of a future version of this deployable.
   */
