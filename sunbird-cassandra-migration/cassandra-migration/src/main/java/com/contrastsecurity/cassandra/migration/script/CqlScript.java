...
/**
 * Cql script containing a series of statements terminated by a delimiter (eg: ;). Single-line (--)
 * and multi-line (/* * /) comments are stripped and ignored.
 */
    ...
    for (int lineNumber = 1; lineNumber <= lines.size(); lineNumber++) {
      ...
      if (cqlStatementBuilder.isEmpty()) {
        ...
        if (newDelimiter != null) {
          ...
          // Skip this line as it was an explicit delimiter change directive outside of any
          // statements.
          continue;
        }
