...
public interface ProfileCompletenessService {
	...
	/**
	 * This method will compute the user profile completeness percentage based on
	 * attribute weighted settings. it will provide completeness percentage value
	 * and list of all missing keys.
	 * 
	 * @param profileData
	 *            Map<String,Object>
