...
public interface ResponseMessage {
    ...
    interface Message {
        ...
        String PHONE_VERIFY_ERROR =
                "Please provide a verified phone number in order to create user.";
        ...
        String ENROLMENT_TYPE_VALUE_ERROR =
                "EnrolmentType value must be either open or invite-only.";
        ...
        String PHONE_ALREADY_IN_USE =
                "Phone already in use. Please provide different phone number.";
