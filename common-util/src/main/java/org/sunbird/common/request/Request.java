...
public class Request implements Serializable {
	...
	private void init() {
		...
		if (ExecutionContext.getCurrent().getGlobalContext()
				.containsKey(HeaderParam.CURRENT_INVOCATION_PATH.getParamName())) {
			context.put(HeaderParam.REQUEST_PATH.getParamName(), ExecutionContext.getCurrent().getGlobalContext()
					.get(HeaderParam.CURRENT_INVOCATION_PATH.getParamName()));
		}

		// set request_id
		requestId = (String) ExecutionContext.getCurrent().getGlobalContext()
