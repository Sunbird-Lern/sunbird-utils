...
/**
 * This exception will be used across all backend code. This will send status
...
public class ProjectCommonException extends RuntimeException {
	...
	/**
	 * This code is for client to identify the error and based on that do the
	...
	/**
	 * This method will provide response code, this code will be used in response
	 * header.
	 * 
	 * @return int
	 */
