...
public enum ActorOperations {
	...
	GET_CONTENT("getContent"), CREATE_COURSE("createCourse"), UPDATE_COURSE("updateCourse"), PUBLISH_COURSE("publishCourse"), SEARCH_COURSE("searchCourse"), DELETE_COURSE("deleteCourse"), CREATE_USER("createUser"), UPDATE_USER("updateUser"), LOGIN("login"), LOGOUT("logout"), CHANGE_PASSWORD("changePassword"),
	...
	SAVE_ASSESSMENT("saveAssessment"), GET_ASSESSMENT("getAssessment"), GET_RECOMMENDED_COURSES("getRecommendedCourses"), UPDATE_USER_INFO_ELASTIC("updateUserInfoToElastic"), GET_ROLES("getRoles"), UPDATE_ORG_STATUS("updateOrgStatus"), APPROVE_ORGANISATION("approveOrganisation"),
	JOIN_USER_ORGANISATION("joinUserOrganisation") , APPROVE_USER_ORGANISATION("approveUserOrganisation");
