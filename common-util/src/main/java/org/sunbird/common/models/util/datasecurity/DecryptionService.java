...
/**
 * This service will have data decryption methods.
 * decryption logic will differ based on imp classes.
 * @author Manzarul
 *
 */
public interface DecryptionService {
   ...
   * after decryption it will return same map with decrypted values.
