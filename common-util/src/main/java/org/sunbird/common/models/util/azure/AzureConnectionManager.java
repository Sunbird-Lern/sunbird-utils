...
public class AzureConnectionManager {
	...
	static {
		...
		if (ProjectUtil.isStringNullOREmpty(name) || ProjectUtil.isStringNullOREmpty(key)) {
			ProjectLogger.log("Azure account name and key is not provided by environment variable." + name + " " + key);
			...
			storageAccountString = "DefaultEndpointsProtocol=https;AccountName=" + accountName + ";AccountKey="
					+ accountKey + ";EndpointSuffix=core.windows.net";
		} else {
			accountName = name;
			accountKey = key;
			ProjectLogger.log("Azure account name and key is  provided by environment variable." + name + " " + key);
			storageAccountString = "DefaultEndpointsProtocol=https;AccountName=" + accountName + ";AccountKey="
					+ accountKey + ";EndpointSuffix=core.windows.net";
		}
	}
	...
	/**
	 * This method will provide Azure CloudBlobContainer object or in case of error
	 * it will provide null;
	 * 
	 * @param containerName
	 *            String
