...
/**
 * @author Manzarul This interface will handle all call related to single sign
 *         out.
 */
public interface SSOManager {

	/**
	 * This method will verify user access token and provide userId if token is
	 * valid. in case of invalid access token it will throw ProjectCommon exception
	 * with 401.
	 * 
	 * @param token
	...
	/**
	 * this method will do the user login with key cloak. after login it will
