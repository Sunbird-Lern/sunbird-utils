...
public class WriteEventHandler implements EventHandler<Request> {
  ...
  public void onEvent(Request request, long l, boolean b) throws Exception {
    try {
      ...
      System.out.println("Event name = " + TelemetryEvents.AUDIT.getName());
      ...
      ProjectLogger.log("WriteEventHandler:onEvent: Exception in disruptor consumer - index: " + l + " exception = " + ex, LoggerEnum.ERROR.name());
    }
  }
