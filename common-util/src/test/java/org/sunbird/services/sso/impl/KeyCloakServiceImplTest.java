...
public class KeyCloakServiceImplTest extends BaseForHttpTest{
	...
	public static void init() {
		...
		try {
			...
			doReturn(response).doThrow(new ProjectCommonException(
		              ...
		              ResponseCode.CLIENT_ERROR.getResponseCode())).doReturn(response).when(usersRes).create(Mockito.any(UserRepresentation.class));
			...
			e.printStackTrace();
			Assert.fail("Failed in initialization of mock rules, underlying error: " + e.getLocalizedMessage());
		}
	}
