...
/**
 * @author github.com/iostream04 This class will Test
 *         KeyCloakRsaKeyFetcherTest's getPublicKeyFromKeyCloak method .
 */
...
public class KeyCloakRsaKeyFetcherTest {
  ...
  public void getPublicKeyFromKeyCloakTestFail() {
    PublicKey key = new KeyCloakRsaKeyFetcher().getPublicKeyFromKeyCloak(KeyCloakConnectionProvider.SSO_URL, FAIL_TEST);
    boolean check = false;
    if (key != null) {
      check = true;
    }
