...
public class ExceptionTest {
	...
	public void testProjectCommonException() {
		ProjectCommonException exception = new ProjectCommonException(ResponseCode.apiKeyRequired.getErrorCode(),
				ResponseCode.apiKeyRequired.getErrorMessage(), ResponseCode.CLIENT_ERROR.getResponseCode());
