...
@PrepareForTest({ OutputStreamWriter.class, URL.class, BufferedReader.class, HttpUtil.class,HttpClients.class, Notification.class,KeyCloakConnectionProvider.class, KeyCloakServiceImpl.class })
