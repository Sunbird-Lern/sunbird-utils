...
public class ActorOperationTest {
	...
	public void testActorOperation() {
		...
		Assert.assertEquals("updateTenantPreference", ActorOperations.UPDATE_TENANT_PREFERENCE.getValue());
		...
		Assert.assertEquals("createTanentPreference", ActorOperations.CREATE_TENANT_PREFERENCE.getValue());
		...
		Assert.assertEquals("login", ActorOperations.LOGIN.getValue());
		Assert.assertEquals("logout", ActorOperations.LOGOUT.getValue());
		Assert.assertEquals("changePassword", ActorOperations.CHANGE_PASSWORD.getValue());
		...
		Assert.assertEquals("approveOrg", ActorOperations.APPROVE_ORG.getValue());
		Assert.assertEquals("userAuth", ActorOperations.USER_AUTH.getValue());
		...
		Assert.assertEquals("getRecommendedCourses", ActorOperations.GET_RECOMMENDED_COURSES.getValue());
		Assert.assertEquals("updateUserInfoToElastic", ActorOperations.UPDATE_USER_INFO_ELASTIC.getValue());
		...
		Assert.assertEquals("joinUserOrganisation", ActorOperations.JOIN_USER_ORGANISATION.getValue());
		Assert.assertEquals("addMemberOrganisation", ActorOperations.ADD_MEMBER_ORGANISATION.getValue());
		Assert.assertEquals("removeMemberOrganisation", ActorOperations.REMOVE_MEMBER_ORGANISATION.getValue());
		Assert.assertEquals("approveUserOrganisation", ActorOperations.APPROVE_USER_ORGANISATION.getValue());
		Assert.assertEquals("compositeSearch", ActorOperations.COMPOSITE_SEARCH.getValue());
		Assert.assertEquals("getUserDetailsByLoginId", ActorOperations.GET_USER_DETAILS_BY_LOGINID.getValue());
		Assert.assertEquals("updateOrgInfoToElastic", ActorOperations.UPDATE_ORG_INFO_ELASTIC.getValue());
		Assert.assertEquals("rejectUserOrganisation", ActorOperations.REJECT_USER_ORGANISATION.getValue());
		Assert.assertEquals("insertOrgInfoToElastic", ActorOperations.INSERT_ORG_INFO_ELASTIC.getValue());
		Assert.assertEquals("downloadUsersData", ActorOperations.DOWNLOAD_USERS.getValue());
		...
		Assert.assertEquals("orgConsumptionMetrics", ActorOperations.ORG_CONSUMPTION_METRICS.getValue());
		Assert.assertEquals("orgCreationMetricsData", ActorOperations.ORG_CREATION_METRICS_DATA.getValue());
		Assert.assertEquals("courseProgressMetrics", ActorOperations.COURSE_PROGRESS_METRICS.getValue());
		Assert.assertEquals("courseConsumptionMetrics", ActorOperations.COURSE_CREATION_METRICS.getValue());
		Assert.assertEquals("userCreationMetrics", ActorOperations.USER_CREATION_METRICS.getValue());
		Assert.assertEquals("userConsumptionMetrics", ActorOperations.USER_CONSUMPTION_METRICS.getValue());
		...
		Assert.assertEquals("insertUserCoursesInfoToElastic",
				ActorOperations.INSERT_USR_COURSES_INFO_ELASTIC.getValue());
		Assert.assertEquals("updateUserCoursesInfoToElastic",
		...
		Assert.assertEquals("courseProgressMetricsReport", ActorOperations.COURSE_PROGRESS_METRICS_REPORT.getValue());
		Assert.assertEquals("courseConsumptionMetricsReport",
		...
		Assert.assertEquals("fileGenerationAndUpload", ActorOperations.FILE_GENERATION_AND_UPLOAD.getValue());
		...
		Assert.assertEquals("courseProgressMetricsData", ActorOperations.COURSE_PROGRESS_METRICS_DATA.getValue());
		...
		Assert.assertEquals("insertUserNotesToElastic", ActorOperations.INSERT_USER_NOTES_ES.getValue());
		...
		Assert.assertEquals("updateUserNotesToElastic", ActorOperations.UPDATE_USER_NOTES_ES.getValue());
		...
		Assert.assertEquals("forgotpassword", ActorOperations.FORGOT_PASSWORD.getValue());
	}
}
