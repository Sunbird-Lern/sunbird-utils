...
public class ActorOperationTest {
	...
	public void testActorOperation () {
		...
		Assert.assertEquals("insertUserCoursesInfoToElastic",ActorOperations.INSERT_USR_COURSES_INFO_ELASTIC.getValue());
		Assert.assertEquals("updateUserCoursesInfoToElastic",ActorOperations.UPDATE_USR_COURSES_INFO_ELASTIC.getValue());
		...
		Assert.assertEquals("courseConsumptionMetricsReport",ActorOperations.COURSE_CREATION_METRICS_REPORT.getValue());
