...
public class ProjectUtilTest {
  ...
  public void testMailTemplateContextCheckFromMail(){
    ...
    VelocityContext context = ProjectUtil.getContext(templateMap);
    if(envVal){
      assertEquals(System.getenv(JsonKey.EMAIL_SERVER_FROM) , (String)context.internalGet(JsonKey.FROM_EMAIL));
    }else if(cacheVal){
      assertEquals(propertiesCache.getProperty(JsonKey.EMAIL_SERVER_FROM) , (String)context.internalGet(JsonKey.FROM_EMAIL));
    }
  ...
  public void testMailTemplateContextCheckOrgImageUrl(){
    ...
    VelocityContext context = ProjectUtil.getContext(templateMap);
    if(envVal){
      assertEquals(System.getenv(JsonKey.SUNBIRD_ENV_LOGO_URL) , (String)context.internalGet(JsonKey.ORG_IMAGE_URL));
    }else if(cacheVal){
      assertEquals(propertiesCache.getProperty(JsonKey.SUNBIRD_ENV_LOGO_URL) , (String)context.internalGet(JsonKey.ORG_IMAGE_URL));
    }
