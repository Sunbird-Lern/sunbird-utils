...
public class UserRequestValidatorTest {
  ...
  public void validateUserSuccessLogin() {
    ...
    request.setRequest(requestObj);
    try {
    UserRequestValidator.validateUserLogin(request);
    response = true;
    } catch (ProjectCommonException e) {
    	Assert.assertNull(e);
	}
  ...
  public void validateCreateUser2 () {
    ...
    UserRequestValidator.validateCreateUser(request);
      ...
      assertEquals(ResponseCode.addressError.getErrorCode(),
          e.getCode());
    }
  }
  ...
  public void validatePhone () {
    ...
    UserRequestValidator.phoneValidation(request);
      ...
      assertEquals(ResponseCode.invalidPhoneNumber.getErrorCode(),
          e.getCode());
    }
  }
  ...
  public void validatePhoneAndEmailUpdate1 () {
    ...
    UserRequestValidator.phoneValidation(request);
         ...
         assertEquals(ResponseCode.invalidCountryCode.getErrorCode(),
             e.getCode());
    }
  }
  ...
  public void validatePhoneAndEmailUpdate3 () {
    ...
    UserRequestValidator.phoneValidation(request);
         ...
         assertEquals(ResponseCode.phoneVerifiedError.getErrorCode(),
             e.getCode());
    }
  }
 ...
 /* @Test
  public void phoneAndEmailValidationForUpdateUser () {
    ...
    request.setRequest(requestObj);
    try {
    UserRequestValidator.phoneAndEmailValidationForUpdateUser(request);
     response = true;
    } catch (ProjectCommonException e) {
    	Assert.assertNull(e);
	}
  ...
  public void validateWebPagesTestWhenNull(){
    ...
    public void doUserBasicValidationTest1() {
      ...
      try {
        ...
        assertEquals(ResponseCode.CLIENT_ERROR.getResponseCode(),
            e.getResponseCode());
        assertEquals(ResponseCode.emailorPhoneRequired.getErrorCode(),
            e.getCode());
      }
  }
    ...
    public void doUserBasicValidationTest2() {
      ...
      try {
        ...
        assertEquals(ResponseCode.CLIENT_ERROR.getResponseCode(),
            e.getResponseCode());
        assertEquals(ResponseCode.emailFormatError.getErrorCode(),
            e.getCode());
      }
  }
   ...
   // @Test
    ...
    public void educationValidationTest1(){
      ...
      try {
        ...
        assertEquals(ResponseCode.CLIENT_ERROR.getResponseCode(),
            e.getResponseCode());
        assertEquals(ResponseCode.educationNameError.getErrorCode(),
            e.getCode());
      }
    }
    ...
    public void jobProfileValidationTest1(){
      ...
      try {
        ...
        assertEquals(ResponseCode.CLIENT_ERROR.getResponseCode(),
            e.getResponseCode());
        assertEquals(ResponseCode.jobNameError.getErrorCode(),
            e.getCode());
      }
    }
    ...
    public void jobProfileValidationTest5(){
      ...
      try {
        ...
        assertEquals(ResponseCode.CLIENT_ERROR.getResponseCode(),
            e.getResponseCode());
        assertEquals(ResponseCode.organisationNameError.getErrorCode(),
            e.getCode());
      }
    }
    ...
    public void validateGetUserCountTest1(){
      ...
      try {
        ...
        assertEquals(ResponseCode.CLIENT_ERROR.getResponseCode(),
            e.getResponseCode());
        assertEquals(ResponseCode.locationIdRequired.getErrorCode(),
            e.getCode());
      }
    }
    ...
    public void validateGetUserCountTest3(){
      ...
      try {
        ...
        assertEquals(ResponseCode.CLIENT_ERROR.getResponseCode(),
            e.getResponseCode());
        assertEquals(ResponseCode.functionalityMissing.getErrorCode(),
            e.getCode());
      }
    }
